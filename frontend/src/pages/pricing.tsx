          ...
          <div className="row row-cols-1 row-cols-md-3 mb-3 text-center">
            <div className="col">
              <div className="card mb-4 rounded-3 shadow-sm">
                ...
                <div className="card-body">
                  <h1 className="card-title pricing-card-title">$0<small className="text-muted fw-light">/mo</small>
                  </h1>
            ...
            <div className="col">
              <div className="card mb-4 rounded-3 shadow-sm">
                ...
                <div className="card-body">
                  <h1 className="card-title pricing-card-title">$15<small className="text-muted fw-light">/mo</small>
                  </h1>
                  <ul className="list-unstyled mt-3 mb-4">
            ...
            <div className="col">
              <div className="card mb-4 rounded-3 shadow-sm border-primary">
                ...
                <div className="card-body">
                  <h1 className="card-title pricing-card-title">$29<small className="text-muted fw-light">/mo</small>
                  </h1>
                  <ul className="list-unstyled mt-3 mb-4">
          ...
          <div className="row">
            ...
            <div className="col-6 col-md">
              ...
              <ul className="list-unstyled text-small">
                ...
                <li className="mb-1"><a className="link-secondary text-decoration-none" href="#">Stuff for
                  developers</a></li>
            ...
            <div className="col-6 col-md">
              ...
              <ul className="list-unstyled text-small">
                ...
                <li className="mb-1"><a className="link-secondary text-decoration-none" href="#">Another resource</a>
                </li>
